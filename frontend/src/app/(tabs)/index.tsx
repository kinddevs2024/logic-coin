...
const styles = StyleSheet.create({
  ...
  activityItem: { flex: 1, minWidth: 0, flexDirection: "column", alignItems: "flex-start", justifyContent: "center", gap: 8, paddingHorizontal: 8 },
  activityInfo: { flex: 0, width: "100%", minWidth: 0, flexDirection: "column", alignItems: "flex-start", gap: 6 },
  ...
  activityCopy: { flex: 0, width: "100%", minWidth: 0, maxWidth: "100%", alignItems: "flex-start", gap: 2 },
  activityTitle: { fontSize: 13, lineHeight: 17, fontWeight: "800", textAlign: "left", flexShrink: 1 },
