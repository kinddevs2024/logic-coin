...
router.get("/blocked-devices", async (_request, response) => {
  response.json({ data: { devices: await listBannedDevices() } });
});

router.post("/blocked-devices/:deviceId/unban", async (request, response) => {
